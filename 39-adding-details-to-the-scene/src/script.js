...
//portal material
debugObject.portalColorStart = '#7721FF'
debugObject.portalColorEnd = '#3150FD'
...
const firefliesMaterial = new THREE.ShaderMaterial({
    ...
    transparent: true,
    blending: THREE.AdditiveBlending, // blends colors
    depthWrite: false,
})

gui.add(firefliesMaterial.uniforms.uSize, 'value').min(0).max(500).step(1).name('fireflySize')
//points
